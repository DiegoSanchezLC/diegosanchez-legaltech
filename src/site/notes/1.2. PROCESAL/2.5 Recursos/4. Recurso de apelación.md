...
A su vez, se enlaza el siguiente esquema general.
...
1. Por escrito;
2. Formalidades comunes a todo escrito;
3. Contener fundamentos de hecho y de
derecho en que se apoya*;
4. Contener peticiones concretas que se 
formulan al tribunal de alzada*.

Excepción: apelación subsidiaria ejemplo
ART 319 CPC.

A. Concesión del recurso de apelación

B. Denegación del recurso de apelación

1. Deducido dentro de plazo;
2. Resolución recurrida susceptible
de apelación;
3. Recurso fundado y con peticiones 
concretas.

No cumpla con alguno de los requisitos
anteriores.

A o B tribunal resuelve de 
plano, sin necesidad de oír 
a la contraria.
...
"No ha lugar por inadmisible/
extemporáneo"


Error o injusticia cometida

Recurso de hecho


Distinción: sólo efecto devolutivo
o ambos efectos


Remisión de antecedentes al 
tribunal de alzada

Ingreso de autos al
tribunal superior

Asignación de número y 
Rol CORTE.


A. Formación cuaderno electrónico separado
(Sólo efecto devolutivo)

B. No se forma nuevo cuaderno (ambos 
efectos).

PRIMER EXAMEN DE ADMISIBILIDAD

CA examina en cuenta:
1. Recurso es admisible; 
2. Si ha sido interpuesto
dentro de plazo

SEGUNDO EXAMEN DE ADMISIBILIDAD

Conclusiones a que puede arribar

A. Recurso inadmisible

A.1 Inadmisible "desde luego"

A.2 Mandar traer autos en
relación


Vuelta del proceso al inferior
...
Excepción: 5 días desde
certificación de ingreso de
carpeta electrónica, se 
soliciten alegatos

Cualquier resolución que 
no sea SD
...
No solicitud de alegatos:

Resuelve la CA con la 
sola cuenta que se le
ha dado
...
Trámite de hacerse parte: corre en 
forma paralela a esta recepción. 
Se hace parte, en otrosíes solicita
alegatos y medios electrónicos y correo

Anuncio de causas que 
no se van a ver:
- "Saldrá en trámite"; o
- Suspendidas

"Hacer salir la causa en 
trámite" POSIBILIDAD.
...
Atraso plazo judicial +
plazo prudencial

Pedir audiencia; en la 
negativa QUEJA 
DISCIPLINARIA
...
Caso en que somos apelados

En este mismo plazo,
ocurre la "adhesión a 
la apelación"

## Element Links
PLZKBtzI: [[1.2. PROCESAL/Legislación actualizada/CPC Código de Procedimiento Civil\|CPC Código de Procedimiento Civil]]
